...
export const mediaPersonnel: MediaPersonnel[] = [
  ...
  { name: "Dr. Olusegun Adeniyi", title: "Chairman, NTA Board", shortTitle: "NTA", loyalty: 65, competence: 70, tenure: "Since Sep 2023", note: "Former presidential spokesperson. Moderate voice. NTA viewership declining.", relationship: "Neutral", avatar: "OA" },
