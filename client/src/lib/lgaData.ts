// lgaData.ts — All 774 Nigerian LGAs across 36 states + FCT
// Source: Nigerian constitution, INEC, and NPC data
...
export const LGA_BY_STATE: Record<string, string[]> = {
  ...
  Osun: [
    "Aiyedaade", "Aiyedire", "Atakumosa East", "Atakumosa West", "Ayedaade",
...
export function getLGACount(): number {
  return Object.values(LGA_BY_STATE).reduce((sum, lgas) => sum + lgas.length, 0);
}
...
export function getAllStates(): string[] {
  return Object.keys(LGA_BY_STATE);
}
